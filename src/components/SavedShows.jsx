        ...
        >
          {movies.map((item) => {
            return (
              <div
                key={item.id}
                className="w-[160px] sm:w-[200px] mid:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2"
              >
                <img
                ...
                <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white">
                  <p className="white-space-n ormal text-xs mid:text-sm font-bold flex justify-center items-center h-full text-center">
                    {item?.title}
                  </p>
                  <p
                    onClick={() => {
